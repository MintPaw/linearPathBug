...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Company Name", "LinearPathBug", "com.sample.linearpathbug", "1.0.0");
		...
		telemetryConfig.app_name = "LinearPathBug";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "LinearPathBug", null, { width: 1280, height: 720 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			name: "LinearPathBug",
			orientation: "",
			packageName: "com.sample.linearpathbug",
			version: "1.0.0",
			windows: [
